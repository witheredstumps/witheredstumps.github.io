...
<b>Definition</b>. For $$\alpha \in H_2(M, \partial M; \Bbb Z)$$, the Thurston norm of $$\alpha$$ is defined as 
...
<b>Observation</b>. Let $$M$$ be irreducible (i.e., all embedded spheres either bound a ball or are boundary-parallel). If $$(S, \partial S) \subset M$$ realizes Thurston norm in its homology class (we shall say: $$(S, \partial S)$$ minimizes the norm), then $$S$$ is incompressible.
